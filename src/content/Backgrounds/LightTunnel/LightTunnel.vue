...
interface MainUniforms {
  ...
  uFlowDir: ScalarUniform;
  uPulseSpeed: ScalarUniform;
  uPulseLength: ScalarUniform;
  uPulseBlend: ScalarUniform;
  uPulseWidth: ScalarUniform;
  uCableCount: ScalarUniform;
  uThickness: ScalarUniform;
  uRimWidth: ScalarUniform;
  uWaviness: ScalarUniform;
  uSway: ScalarUniform;
  uSize: ScalarUniform;
  uCenter: Vec2Uniform;
  uMouseOffset: Vec2Uniform;
  uGlow: ScalarUniform;
  uFadeNear: ScalarUniform;
  uFadeFar: ScalarUniform;
  uBrightness: ScalarUniform;
  uColorVariance: ScalarUniform;
  uOpacity: ScalarUniform;
  uCableColor: Vec3Uniform;
  uPulseColor: Vec3Uniform;
  uTunnelColor: Vec3Uniform;
  uTunnelOpacity: ScalarUniform;
  uGrain: ScalarUniform;
  uGrainIntensity: ScalarUniform;
}

const props = withDefaults(defineProps<LightTunnelProps>(), {
  cableColor: '#10B981',
  pulseColor: '#10B981',
  tunnelColor: '#84CC16',
  tunnelOpacity: 0,
...
onMounted(() => {
  ...
  const loop = (t: number) => {
    ...
    const off = mu.uMouseOffset.value;
