...
interface MainUniforms {
  ...
  uThreadCount: ScalarUniform;
  uFrequency: ScalarUniform;
  uSpread: ScalarUniform;
  uTaper: ScalarUniform;
  uPosition: ScalarUniform;
  uFanMode: ScalarUniform;
  uGlow: ScalarUniform;
  uFalloff: ScalarUniform;
  uThickness: ScalarUniform;
  uBrightness: ScalarUniform;
  uOpacity: ScalarUniform;
  uMirror: ScalarUniform;
  uShimmer: ScalarUniform;
...
const props = withDefaults(defineProps<WebThreadsProps>(), {
  color1: '#5227FF',
  color2: '#FF9FFC',
  color3: '#FFFFFF',
  speed: 0.2,
...
const syncUniforms = () => {
  ...
  u.uThreadCount.value = Math.round(props.threadCount);
  u.uFrequency.value = props.frequency;
  u.uSpread.value = props.spread;
  u.uTaper.value = props.taper;
  u.uPosition.value = props.position;
  u.uFanMode.value = FAN_MODE[props.fanMode] ?? 0;
  ...
  u.uMirror.value = props.mirror ? 1.0 : 0.0;
  u.uShimmer.value = props.shimmer ? 1.0 : 0.0;
