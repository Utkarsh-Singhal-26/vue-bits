...
interface MainUniforms {
  ...
  uAmplitude: ScalarUniform;
  uWaveScale: ScalarUniform;
  uWaveRatio: ScalarUniform;
  uSwell: ScalarUniform;
  uTurbulence: ScalarUniform;
  uTilt: ScalarUniform;
  uZoom: ScalarUniform;
  uHeight: ScalarUniform;
  uFogDepth: ScalarUniform;
  ...
  uMouse: Vec2Uniform;
  uParallax: ScalarUniform;
  uEnableMouse: BoolUniform;
  uHorizonColor: Vec3Uniform;
  uWaveColor: Vec3Uniform;
  uCrestColor: Vec3Uniform;
}
